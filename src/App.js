  ...
  return (
    <Container>
      <Card
        ...
        body="This website is being written using React and TailwindCSS and is still very much a work in progress.
      ...
      >
        <a className="text-cyan-200" href="https://github.com/redwinbee">
          @GitHub
        </a>
      </Card>
    </Container>
